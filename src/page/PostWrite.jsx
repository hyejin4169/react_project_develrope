...
const PostWrite = (props) => {
  ...
  if (!is_login) {
    return (
      <Grid
        ...
        padding="10vh 0 0 0"
      >
        <Text bold="700" size="30px">
          앗, 포스팅 전에
        </Text>
        <Text bold="700" size="30px" margin="1vw 0 0 0">
          먼저 로그인해주세요!
        </Text>
        <Button
          _onClick={() => {
  ...
  return (
    <>
      ...
      <Grid flex padding="16px" maxWidth='1000px' margin="auto">
        <Grid>
        ...
        <Grid ps="relative" radius="8px" overflow="hidden" margin="0 0 0 20px">
          {preview ? <Image shape="rectangle" src={preview} /> : <PreviewBox />}
        </Grid>
      </Grid>
